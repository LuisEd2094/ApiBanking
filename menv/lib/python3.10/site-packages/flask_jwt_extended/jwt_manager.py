...
class JWTManager(object):
    ...
    def _set_default_configuration_options(app: Flask) -> None:
        ...
        app.config.setdefault("JWT_REFRESH_COOKIE_NAME",
    ...
    def _decode_jwt_from_config(
        ...
        secret = self._decode_key_callback(
            unverified_headers, unverified_claims)
        ...
        try:
            ...
            e.jwt_data = _decode_jwt(
                **kwargs, allow_expired=True)  # type: ignore
            raise
