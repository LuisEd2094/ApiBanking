...
def _get_parameter_help(
    *,
    ...
    if envvar is not None:
        var_str = (
            envvar if isinstance(envvar, str) else ", ".join(
    ...
    if envvar and getattr(param, "show_envvar", None):
        items.append(Text(ENVVAR_STRING.format(
            var_str), style=STYLE_OPTION_ENVVAR))
    ...
    *,
    ...
    for param in obj.get_params(ctx):
        ...
        if isinstance(param, click.Argument):
            panel_name = (
                getattr(param, _RICH_HELP_PANEL_NAME,
